 ...
 *
 */
public class SwitchPopShotPosition extends BBCommandGroup {

    public SwitchPopShotPosition() {
    	
    	addSequential(new RollerOff());
    	
    	addParallel(new SetLiftPosition(LiftConst.defensePosition));
    	addSequential(new CoordinatedMove(ArmConst.lowerLimit, HandConst.Defense));
