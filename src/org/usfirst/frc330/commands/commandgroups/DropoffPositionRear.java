 ...
 *
 */
public class DropoffPositionRear extends BBCommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public DropoffPositionRear() {

    	addSequential(new SetHandAngleRelArm(HandConst.encFrameSafe));
    	addParallel(new SetLiftPosition(LiftConst.scaleDropoffMid));
    	addSequential(new SetArmAngle(ArmConst.vertical));
    	addSequential(new SetHandAngle(HandConst.rearLevel));
