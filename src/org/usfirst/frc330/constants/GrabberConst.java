...
public final class GrabberConst {
	...
	public static final double sensorMinimumOuterDistance				= 2.0;				//(inches) EJO 2.10.18
	public static final double sensorMinimumInnerDistance				= 12.0;				//(inches) EJO 2.10.18
