...
import org.usfirst.frc330.wpilibj.Kalman;
...
public class Grabber extends Subsystem {
    ...
    private Kalman leftKalman, centerKalman, rightKalman;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        leftKalman = new Kalman(GrabberConst.kalmanProcessNoise, GrabberConst.kalmanSensorNoise, GrabberConst.kalmanEstimatedError, grabberIRLeft.getDistance());
        centerKalman = new Kalman(GrabberConst.kalmanProcessNoise, GrabberConst.kalmanSensorNoise, GrabberConst.kalmanEstimatedError, grabberIRCenter.getDistance());
        rightKalman = new Kalman(GrabberConst.kalmanProcessNoise, GrabberConst.kalmanSensorNoise, GrabberConst.kalmanEstimatedError, grabberIRRight.getDistance());
...
//		CSVLogger.getInstance().add("HasCubeCanted", temp);		
    ...
    public double getSensorLOutput() {
    	...
    	return leftKalman.getFilteredValue(grabberIRLeft.getDistance());
    }
    ...
    public double getSensorROutput() {
    	...
    	return rightKalman.getFilteredValue(grabberIRRight.getDistance());
    }
