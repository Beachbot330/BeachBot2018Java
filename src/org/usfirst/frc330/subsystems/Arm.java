...
public class Arm extends Subsystem {
    ...
    public void periodic() {
    	...
    	if(!calibrated) {
    		if(limitSwitch.get()) {
    			armL.setSelectedSensorPosition(degreesToTicks(ArmConst.limitSwitchAngle), 0, 0);
    			armL.disable();
    			calibrated = true;
    			armL.configForwardSoftLimitThreshold(degreesToTicks(ArmConst.upperLimit), 0);
    			armL.configReverseSoftLimitThreshold(degreesToTicks(ArmConst.lowerLimit), 0);
    			armL.configForwardSoftLimitEnable(true, 0);
    			armL.configReverseSoftLimitEnable(true, 0);
    		}
    	}
    }
	...
	{
		return (ticksToDegrees((int)armL.configGetParameter(ParamEnum.eForwardSoftLimitThreshold, 0, 0)));
	}
    
    public double getUpperLimit()
	{
		return (ticksToDegrees((int)armL.configGetParameter(ParamEnum.eReverseSoftLimitThreshold, 0, 0)));
	}
