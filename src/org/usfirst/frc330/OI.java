...
public class OI {
    ...
    public JoystickButton scaleMidDropoff_4;
    public JoystickButton scaleDropoffRear_5;
    public JoystickButton scaleTallDropoff_6;
    public JoystickButton killAll_7;
    public JoystickButton killAll_8;
    public TwoJoystickButton climbReady_Deply_10_9;
    public JoystickButton alignReady_10;
    ...
    public OI() {
        ...
        alignReady_10 = new JoystickButton(armGamePad, 10);
        alignReady_10.whenReleased(new AlignReady());
        climbReady_Deply_10_9 = new TwoJoystickButton(armGamePad, 10, 9);
        climbReady_Deply_10_9.whileHeld(new ClimbDeploy(), new ClimbReady());
        ...
        scaleMidDropoff_4.whenPressed(new dropoffPositionMed());
