...
public class OI {
    ...
    public JoystickButton twoButtonClimbDeploy_45;
    ...
    public JoystickButton noSensorPickupDown_7;
    public JoystickButton killAll_8;
    public JoystickButton powerUpDropOff_10;
    public JoystickButton scaleMidDroppoff90_9;
    public JoystickButton noSensorPickupUp_7;
    ...
    public OI() {
        ...
        noSensorPickupUp_7 = new JoystickButton(armGamePad, 7);
        noSensorPickupUp_7.whenReleased(new SensorlessPickupUp());
        scaleMidDroppoff90_9 = new JoystickButton(armGamePad, 9);
        scaleMidDroppoff90_9.whenPressed(new DropoffPositionMed90());
        powerUpDropOff_10 = new JoystickButton(armGamePad, 10);
        powerUpDropOff_10.whenPressed(new DropoffPowerUp());
        killAll_8 = new JoystickButton(armGamePad, 8);
        killAll_8.whenPressed(new KillAll());
        noSensorPickupDown_7 = new JoystickButton(armGamePad, 7);
        noSensorPickupDown_7.whileHeld(new SensorlessPickupDown());
        ...
        twoButtonClimbDeploy_45 = new JoystickButton(driverR, 4);
        twoButtonClimbDeploy_45.whileHeld(new TwoButtonPlatformDeploy());
